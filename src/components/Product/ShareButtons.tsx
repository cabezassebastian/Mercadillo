  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="flex items-center space-x-2 px-4 py-2 bg-white border-2 border-amarillo text-gris-oscuro rounded-lg hover:bg-amarillo hover:text-white transition-all duration-200 shadow-sm"
      ...
      {showMenu && (
        <>
          ...
          <div className="absolute left-0 mt-2 w-64 bg-white rounded-lg shadow-xl border border-gray-200 z-50 overflow-hidden">
            <div className="p-3 bg-amarillo text-white font-semibold text-sm">
            ...
            <div className="py-2">
              ...
              <button
                ...
                className="w-full px-4 py-3 flex items-center space-x-3 hover:bg-green-50 transition-colors duration-150"
              >
                <MessageCircle className="w-5 h-5 text-green-600" />
                <div className="text-left flex-1">
                  <div className="font-medium text-gris-oscuro">WhatsApp</div>
                  <div className="text-xs text-gray-500">Comparte por mensaje</div>
                </div>
              </button>
              ...
              <button
                ...
                className="w-full px-4 py-3 flex items-center space-x-3 hover:bg-blue-50 transition-colors duration-150"
              >
                <Facebook className="w-5 h-5 text-blue-600" />
                <div className="text-left flex-1">
                  <div className="font-medium text-gris-oscuro">Facebook</div>
                  <div className="text-xs text-gray-500">Comparte en tu muro</div>
                </div>
              </button>
              ...
              >
                ...
                <div className="text-left flex-1">
                  <div className="font-medium text-gris-oscuro">Twitter/X</div>
                  <div className="text-xs text-gray-500">Publica un tweet</div>
                </div>
              </button>
              ...
              <button
                ...
                className="w-full px-4 py-3 flex items-center space-x-3 hover:bg-red-50 transition-colors duration-150"
              >
                ...
                <div className="text-left flex-1">
                  <div className="font-medium text-gris-oscuro">Pinterest</div>
                  <div className="text-xs text-gray-500">Guarda en tablero</div>
                </div>
              </button>
              ...
              <button
                ...
                className="w-full px-4 py-3 flex items-center space-x-3 hover:bg-amarillo/10 transition-colors duration-150"
              >
                {copied ? (
                ...
                <div className="text-left flex-1">
                  <div className="font-medium text-gris-oscuro">
            ...
            {/* Footer con marca */}
            <div className="p-3 bg-gray-50 text-center text-xs text-gray-600 border-t border-gray-200">
