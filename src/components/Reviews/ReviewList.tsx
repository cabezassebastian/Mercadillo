              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 text-sm text-blue-700 dark:text-blue-300">
                    ...
                    {userReview?.created_at ? formatDate(userReview.created_at) : ''}
                  </div>
                </div>
              </div>
              <button
                onClick={() => userReview?.id && handleDeleteReview(userReview.id, true)}
                disabled={userReview?.id ? isDeleting === userReview.id : false}
                className="
