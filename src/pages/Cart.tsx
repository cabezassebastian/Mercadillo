      ...
      <div className="min-h-screen bg-hueso py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center py-16">
            ...
            <h1 className="text-3xl font-bold text-gris-oscuro mb-4">
            ...
            {items.map((item) => (
              <div key={item.producto.id} className="card p-6">
                <div className="flex items-center space-x-4">
                  <div className="w-20 h-20 overflow-hidden rounded-lg bg-gray-100">
                    <img
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-gris-oscuro mb-1">
            ...
            <div className="card p-6 sticky top-8">
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="border-t border-gray-200 pt-4">
                  <div className="flex justify-between">
                    <span className="text-lg font-bold text-gris-oscuro">Total:</span>
