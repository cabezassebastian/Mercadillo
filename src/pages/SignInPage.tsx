  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-hueso p-4 sm:p-6">
      <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-lg w-full max-w-sm sm:max-w-md text-center">
        ...
        <h1 className="text-xl sm:text-2xl font-bold text-gris-oscuro mb-2">Bienvenido de vuelta</h1>
        <p className="text-gris-claro text-sm sm:text-base mb-6">Inicia sesión para continuar</p>
        <SignIn
          path="/sign-in"
          routing="path"
          signUpUrl="/sign-up"
